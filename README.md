...
## หลักฐานการทำงานของ LINE Notification

สกรีนช็อตจากการใช้งานจริง ไม่ใช่ mock:

**1. แชทของแอดมิน — เห็นทั้งข้อความแจ้งเตือน "มีคนจอง" (ฝั่งแอดมิน) และข้อความยืนยันของตัวเอง (ตอนแอดมินทดสอบจองด้วยบัญชีตัวเอง)**

![Admin เห็นทั้งแจ้งเตือนแอดมินและแจ้งเตือนของตัวเอง](docs/line-proof-1-admin-and-self.png)

**2. แชทของแอดมิน — เห็นการแจ้งเตือน "มีคนจอง" จากการจองของ user2 (คนละบัญชีกับแอดมิน)**

![Admin เห็นการจองของ user2](docs/line-proof-2-admin.png)

**3. แชทของ user2 (บัญชี LINE คนละบัญชีกับแอดมิน) — ได้รับข้อความยืนยันการจองของตัวเองโดยตรง**

![user2 ได้รับการแจ้งเตือนของตัวเอง](docs/line-proof-3-user2.jpg)

รูปที่ 2 และ 3 คือการจองเดียวกัน (เช่น "Aug 28, 2026, 6:45 PM — คุยงานที่ออฟฟิศ") แต่ถูกส่งไปหาคนละ LINE account กัน — พิสูจน์ว่าระบบแยกส่งแจ้งเตือนให้แอดมินกับผู้จองเป็นอิสระต่อกันจริง
